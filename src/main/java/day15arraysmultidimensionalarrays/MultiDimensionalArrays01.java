...
public class MultiDimensionalArrays01 {
    public static void main(String[] args) {
        ...
        //Multidimensional Arraylere eleman ekleme nasil alinir?
        arr[0][0] = 3;
        arr[0][1] = -4;
        arr[1][0] = 6;
        arr[1][1] = 18;
        ...
        //Multidimensional Arraylerde Array elemandan biri nazil yazdirilir?
        System.out.println(Arrays.toString(arr[1]));// [6, 18]

        //Multidimensional Arraylerde ic Arraylerdeki elemanlar nasil yazdirilir?

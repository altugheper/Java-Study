...
*/
    ...
    /*
        ...
        1)int: Integer'in kisaltmasi. Tam sayi demek. 32 bit/4 byte kullanir
               Matematik'de tam sayilarin basi ve sonu yoktur
               En kucuk int = -2,147,483,648
               En buyuk int =  2,147,483,647

        2)byte: Tamsayilar icin kullanilir. Memory'de kapladigi yer Integer'a gore daha az. 8 bit kullanir.
                En kucuk byte = -128
                En buyuk byte =  127
        ...
        4)long: Tamsayilar icin. Integer'larin yetmedigi yerde kullanilir. 64 bit kullanir.
                En kucuk long = -9,223,372,036,854,755,808
                En buyuk long =  9,223,372,036,854,755,807

        5)float: Ondalikli sayilar icindir. Virgullu sayilar icin kullanilir. 32 bit kullanir
                 Fiyatlar icin kullanilmasi tavsiye edilir
                 "float" virgulden sonra 7 basamak icerebilir
                 "float" degerlerinde sona "f" veya "F" koymaniz gerekir

        6)double: Ondalikli sayilar icindir. Virgullu sayilar icin kullanilir. 64 bit kullanir.
                  Hassas bilimsel veriler icin kullanilmasi tavsiye edilir
        ...
        8)char: Tek karakterler icin kullanilir. 16 bit kullanir
                ...
                Note: Numeric Data Types: byte < short < int < long < float < double
                      Non-numeric Data Types: boolean - char
          ...
          1)String: Isim, adres, kimlik numarasi, gibi bir veya birden fazla karakter iceren degerlerde kullanilir.
                    ...
                    2) Primitive data type'lari Java tarafindan olusturulmustur, toplam 8 tanedir, biz Primitive data
                       olusturamayiz.
                       Non-Primitive'ler Java tarafindan da olusturulmustur, biz de olusturabiliriz.
                       Non-Primitive'ler sayilamayacak kadar coktur, cunku her developer Non-Primitive data type'i
                       olusturabilir
                    3) Primitive data type'lari isimleri kucuk harflerle baslar

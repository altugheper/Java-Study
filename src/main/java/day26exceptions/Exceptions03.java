...
public class Exceptions03 {
    ...
    //String'deki character sayisini bulunuz, String'i integer'a ceviriniz, interger'i character sayisina bolunuz.
    public static double divideStringByTheNumOfTheChar(String str){
        ...
        try {
            ...
            return i/length; //ArithmeticException: Bolen sayi sifir oldugunda alinir
    ...
    Note: 1)Aralarinda "parent-child" relationship olan Exception Class'lari multiple catch'lerde kullanmak isterseniz
          "child" olan once kullanilmalidir

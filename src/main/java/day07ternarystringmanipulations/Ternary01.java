...
public class Ternary01 {
    public static void main(String[] args) {
        ...
        //2. Yol: ternary
        //Condition dogru ise uygulanacak kod     :          Condition yanlis ise uygulanacak kod
        String sonuc =        1>0 ? "Pozitif"                           :          "Pozitif degil";
        ...
        //Ternary farkli data type'larinda sonuc return ederse, sonucun data type'ini "Object" yapiniz

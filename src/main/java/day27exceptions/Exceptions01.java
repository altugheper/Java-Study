...
public class Exceptions01 {
    ...
    public static double compareNumOfCharacters(String s, String t){
        ...
        try{
            ...
            System.out.println("length () methodu'u null ile kullanilamaz");
    ...
    /*
    "final", "finally", "finalize" aciklayiniz. INTERVIEW QUESTIONS
    ...
    2)"finally" bir "code block"dur
      ...
      "finally" code block icinde yazilan code'lar her halukarda calistirilir
      Mesela Database ile connection'i kesmek herhalukarda yapilmasi gereken bir fiildir. Bunu "finally" ile yapabiliriz
      3)"finalize" bir methoddur. Bu method Java tarafindan data'lar imha edilmeden once cagrilir, bu method data'lari

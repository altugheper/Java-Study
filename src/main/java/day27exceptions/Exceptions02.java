...
public class Exceptions02 {
    ...
    1) FileInputStream fis = new FileInputStream("src\\main\\java\\day27exceptions\\File1.txt");
       ...
       Biz "method isminden" sonra, "throws FileNotFoundException" yazarak, Java'ya bu iki endise duydugun durum olursursa
       "Exception At" dedik.

    2) while ((k = fis.read()) != -1){} yazdigimizda "read()" method'u hata verir. Cunku bniz Java'ya dosya'daki karakterleri
    ...
    3) Method isminden sonra "throws IOException" yazarsaniz Java "throws FileNotFoundException"i siler. Cunku;
       "IOException", "FileNotFoundException" i kapsar. "IOException", "FileNotFoundException" in parentidir, onun yaptigi
